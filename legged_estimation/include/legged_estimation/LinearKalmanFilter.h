...
#include "legged_estimation/ParamConfig.h"
...
class KalmanFilterEstimate : public StateEstimateBase {
 ...
 protected:
  ...
  void dynamicCallback(legged_estimation::ParamConfig& config, uint32_t /*level*/);
 ...
 private:
  ...
  std::shared_ptr<dynamic_reconfigure::Server<legged_estimation::ParamConfig>> dynamic_srv_{};
  scalar_t accXBias_{}, accYBias_{};
  scalar_t vXBias_{}, vYBias_{};
};
